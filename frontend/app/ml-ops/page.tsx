      ...
      <div style={{ padding: 'var(--space-4)', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
              ...
              <GlassPanel key={model.name} static style={isBest ? { border: '1px solid var(--cyan)', boxShadow: '0 0 20px rgba(0, 240, 255, 0.1)' } : undefined}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--space-3)' }}>
                  <div>
                    ...
                    {isBest && <span style={{ fontSize: '0.6rem', color: 'var(--cyan)', fontWeight: 600, marginLeft: 4 }}>{t('MlOps.best')}</span>}
                  </div>
                  <span style={{
                    fontSize: '0.6rem',
                    padding: '2px 8px',
                    ...
                    {model.trained ? t('MlOps.trained') : t('MlOps.pending')}
                  </span>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 'var(--space-2)' }}>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3, marginBottom: 2 }}>
                      ...
                      <span style={{ fontSize: '0.55rem', color: 'var(--text-muted)' }}>{t('MlOps.accuracy')}</span>
                    </div>
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3, marginBottom: 2 }}>
                      ...
                      <span style={{ fontSize: '0.55rem', color: 'var(--text-muted)' }}>{t('MlOps.f1')}</span>
                    </div>
                    <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.9rem', color: 'var(--text-primary)', fontWeight: 700 }}>
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3, marginBottom: 2 }}>
                      ...
                      <span style={{ fontSize: '0.55rem', color: 'var(--text-muted)' }}>{t('MlOps.auc')}</span>
                    </div>
                    <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.9rem', color: 'var(--text-primary)', fontWeight: 700 }}>
            ...
            <GlassPanel static style={{ border: '1px solid var(--cyan)', boxShadow: '0 0 20px rgba(0, 240, 255, 0.1)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--space-3)' }}>
                <div>
                  ...
                  <span style={{ fontSize: '0.6rem', color: 'var(--cyan)', fontWeight: 600, marginLeft: 4 }}>{t('MlOps.best')}</span>
                </div>
                <span style={{
                  fontSize: '0.6rem',
                  padding: '2px 8px',
        ...
        <GlassPanel static>
          <h2 style={{ fontFamily: 'var(--font-data)', fontSize: '0.85rem', fontWeight: 700, color: 'var(--cyan)', marginBottom: 'var(--space-4)', display: 'flex', alignItems: 'center', gap: 8 }}>
            <Brain size={18} />
            {t('MlOps.ensembleConfiguration')}
          </h2>
          <div style={{ fontFamily: 'var(--font-data)', fontSize: '0.75rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
            <p>{t('MlOps.finalScoreFormula')}</p>
            <p style={{ marginTop: 'var(--space-2)' }}>{t('MlOps.alertThresholds')}</p>
            <p style={{ marginTop: 'var(--space-2)' }}>{t('MlOps.datasetsDescription')}</p>
          </div>
        </GlassPanel>

        {/* Hyperparameter Tuning Results */}
        <GlassPanel static title={t('MlOps.modelTrainingHistory')} icon="🏆">
          {trainingHistory.length > 0 ? (
            ...
            <div style={{ textAlign: 'center', padding: 'var(--space-4)', color: 'var(--text-muted)', fontSize: 'var(--text-sm)' }}>
              {t('Common.loading')} training history from server...
            </div>
          )}
        </GlassPanel>
        ...
        <GlassPanel static>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-3)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.7rem', color: 'var(--text-muted)' }}>{t('MlOps.dataset')}</span>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.75rem', color: 'var(--text-primary)', fontWeight: 600 }}>{t('MlOps.nslKdd')}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.7rem', color: 'var(--text-muted)' }}>{t('MlOps.modelsTrainedCount')}</span>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.75rem', color: 'var(--text-primary)', fontWeight: 600 }}>{trainedCount}/3</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.7rem', color: 'var(--text-muted)' }}>{t('MlOps.totalTrainingTime')}</span>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.7rem', color: 'var(--text-muted)' }}>{t('MlOps.features')}</span>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.75rem', color: 'var(--text-primary)', fontWeight: 600 }}>40 (→ 63 live)</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.7rem', color: 'var(--text-muted)' }}>{t('MlOps.ensembleWeights')}</span>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.75rem', color: 'var(--text-primary)', fontWeight: 600 }}>0.30 / 0.45 / 0.25</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.7rem', color: 'var(--text-muted)' }}>{t('MlOps.classes')}</span>
              <span style={{ fontFamily: 'var(--font-data)', fontSize: '0.75rem', color: 'var(--text-primary)', fontWeight: 600 }}>5 ({t('MlOps.normalDosProbeR2lU2r')})</span>
            </div>
          </div>
        </GlassPanel>
          ...
          >
            <div style={{ padding: 'var(--space-4)' }}>
              <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 'var(--space-4)' }}>
                {t('MlOps.confusionMatrixDescription').replace('{n_samples}', selectedMatrix.n_samples.toString())}
              </p>
              <ConfusionMatrix 
