...
export const MOCK_FLOWS: NetworkFlow[] = [
  { id: 'flw-01', src_ip: '10.0.1.5',     dst_ip: '104.21.55.12', src_port: 45231, dst_port: 443,  protocol: 'TCP',  duration: 12.4,  src_bytes: 248000,  dst_bytes: 18400,  total_packets: 320,  anomaly_score: 0.94, is_anomaly: true,  label: 'C2 Communication',  timestamp: new Date(now-60000).toISOString(), src_lat: 9.025, src_lon: 38.747, dst_lat: 55.75, dst_lon: 37.61, src_country: 'ET', dst_country: 'RU' },
  { id: 'flw-02', src_ip: '185.220.101.4', dst_ip: '10.0.1.5',    src_port: 1234,  dst_port: 22,   protocol: 'TCP',  duration: 8.1,   src_bytes: 5200,    dst_bytes: 2100,   total_packets: 48,   anomaly_score: 0.88, is_anomaly: true,  label: 'SSH Brute Force',   timestamp: new Date(now-120000).toISOString(), src_lat: 52.52, src_lon: 13.40, dst_lat: 9.025, dst_lon: 38.747, src_country: 'DE', dst_country: 'ET' },
  { id: 'flw-03', src_ip: '10.0.1.12',    dst_ip: '10.0.1.5',    src_port: 3000,  dst_port: 8080, protocol: 'TCP',  duration: 0.3,   src_bytes: 1200,    dst_bytes: 800,    total_packets: 12,   anomaly_score: 0.08, is_anomaly: false, label: 'Normal',            timestamp: new Date(now-150000).toISOString(), src_lat: 9.025, src_lon: 38.747, dst_lat: 37.77, dst_lon: -122.41, src_country: 'ET', dst_country: 'US' },
  { id: 'flw-04', src_ip: '45.33.32.156',  dst_ip: '10.0.1.5',    src_port: 49200, dst_port: 53,   protocol: 'UDP',  duration: 120.0, src_bytes: 145200,  dst_bytes: 86400,  total_packets: 1840, anomaly_score: 0.81, is_anomaly: true,  label: 'DNS Tunneling',     timestamp: new Date(now-200000).toISOString(), src_lat: 31.23, src_lon: 121.47, dst_lat: 9.025, dst_lon: 38.747, src_country: 'CN', dst_country: 'ET' },
  { id: 'flw-05', src_ip: '10.0.1.23',    dst_ip: '8.8.8.8',     src_port: 52100, dst_port: 53,   protocol: 'UDP',  duration: 0.1,   src_bytes: 120,     dst_bytes: 160,    total_packets: 2,    anomaly_score: 0.12, is_anomaly: false, label: 'Normal',            timestamp: new Date(now-240000).toISOString(), src_lat: 9.025, src_lon: 38.747, dst_lat: 37.38, dst_lon: -122.08, src_country: 'ET', dst_country: 'US' },
  { id: 'flw-06', src_ip: '10.0.1.5',     dst_ip: '192.168.1.1', src_port: 60000, dst_port: 80,   protocol: 'TCP',  duration: 0.5,   src_bytes: 840,     dst_bytes: 4200,   total_packets: 8,    anomaly_score: 0.06, is_anomaly: false, label: 'Normal',            timestamp: new Date(now-280000).toISOString(), src_lat: 9.025, src_lon: 38.747, dst_lat: 9.025, dst_lon: 38.747, src_country: 'ET', dst_country: 'ET' },
  { id: 'flw-07', src_ip: '203.0.113.42',  dst_ip: '10.0.1.8',    src_port: 45000, dst_port: 8080, protocol: 'TCP',  duration: 35.2,  src_bytes: 980000,  dst_bytes: 24000,  total_packets: 1120, anomaly_score: 0.76, is_anomaly: true,  label: 'Data Exfiltration', timestamp: new Date(now-310000).toISOString(), src_lat: -33.86, src_lon: 151.20, dst_lat: 9.025, dst_lon: 38.747, src_country: 'AU', dst_country: 'ET' },
  { id: 'flw-08', src_ip: '10.0.1.5',     dst_ip: '10.0.0.1',    src_port: 34000, dst_port: 161,  protocol: 'UDP',  duration: 0.02,  src_bytes: 84,      dst_bytes: 120,    total_packets: 2,    anomaly_score: 0.03, is_anomaly: false, label: 'Normal',            timestamp: new Date(now-360000).toISOString(), src_lat: 9.025, src_lon: 38.747, dst_lat: 9.025, dst_lon: 38.747, src_country: 'ET', dst_country: 'ET' },
];
